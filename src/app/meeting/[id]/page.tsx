...
// Hook Callback when Deepgram yields transcript
          ...
          <div className="flex-1 flex flex-col md:flex-row overflow-hidden relative">
            ...
            <aside className="w-full md:w-[360px] max-h-[35vh] md:max-h-full bg-white/60 dark:bg-slate-900/40 backdrop-blur-md border-b md:border-b-0 md:border-r border-slate-200/60 dark:border-slate-800 p-4 md:p-7 flex flex-col gap-4 md:gap-8 shrink-0 overflow-y-auto z-10 shadow-[2px_0_15px_-3px_rgba(0,0,0,0.05)] dark:shadow-none custom-scrollbar">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex flex-col bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl shadow-sm overflow-hidden">
                    <div className="flex items-center justify-between p-4">
                      <div className="flex items-center space-x-2.5">
                        ...
                        <span className="text-sm font-bold text-slate-700 dark:text-slate-300">Tạm dừng</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Volume2 className="w-4 h-4 text-slate-400" />
                        <span className="text-xs font-bold text-slate-500 w-8 text-right">0%</span>
                      </div>
                    </div>
                    
                    <div className="px-4 pb-4">
                      <div className="w-full h-2.5 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden shadow-inner">
                        <div className="h-full bg-slate-200 dark:bg-slate-700 w-0"></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-1">
                    <button className="flex items-center justify-center space-x-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl h-11 text-sm font-bold shadow-md shadow-indigo-500/30 opacity-50 cursor-not-allowed">
                      <Mic className="w-4 h-4" />
                      <span>Bắt đầu</span>
                    </button>
                    
                    <button className="flex items-center justify-center space-x-2 bg-red-50 text-red-600 dark:bg-red-900/30 dark:text-red-400 rounded-xl h-11 text-sm font-bold shadow-sm opacity-40 cursor-not-allowed">
              ...
              <div className="space-y-4 flex-1">
                <div className="flex items-center justify-between">
                  ...
                  <button className="flex items-center space-x-1 text-xs font-semibold text-blue-600 dark:text-blue-400 px-2 py-1 opacity-50 cursor-not-allowed">
                ...
                <div className="space-y-3">
                  <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl p-3 shadow-sm transition-all">
                    <div className="flex items-center space-x-3">
                      <span className="w-3 h-3 rounded-full shrink-0 shadow-sm bg-blue-500"></span>
                      <div className="flex-1 bg-transparent border-b border-transparent font-bold text-sm py-1 text-slate-700 dark:text-slate-200">Tôi</div>
              ...
              <div className="space-y-4 pt-6 border-t border-slate-200/60 dark:border-slate-800">
                <button className="flex items-center justify-between w-full text-left font-bold text-xs uppercase tracking-widest text-slate-400 opacity-50 cursor-not-allowed select-none">
            ...
            <main className="flex-1 flex flex-col overflow-hidden bg-slate-50/50 dark:bg-slate-950 p-6 relative">
              <div className="flex-1 flex flex-col items-center justify-center text-center p-8 select-none">
                <Mic className="w-12 h-12 text-slate-300 dark:text-slate-700 mb-4 animate-pulse" />
                <h4 className="font-semibold text-slate-600 dark:text-slate-400">Phòng họp đang được chuẩn bị...</h4>
                <p className="text-xs text-slate-400 max-w-[400px] mt-1">
                  Vui lòng đợi giây lát, đang tải dữ liệu cuộc họp.
                </p>
              </div>
              ...
              <div className="shrink-0 bg-slate-50/40 dark:bg-slate-900/30 backdrop-blur-md border border-dashed border-slate-200 dark:border-slate-800/80 rounded-xl px-4 py-2 flex flex-col shadow-sm">
  ...
  return (
    <div className="h-screen flex flex-col bg-slate-100 dark:bg-slate-900/60 font-sans overflow-hidden">
      ...
      `}</style>
      <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 flex flex-col gap-2 max-w-xs w-full pointer-events-none">
        {toasts.map((t) => {
          const config = {
            success: {
