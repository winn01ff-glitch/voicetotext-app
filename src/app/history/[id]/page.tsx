                ...
                return (
                  <>
                    ...
                    <button
                      ...
                      className={`relative flex-1 flex items-center justify-center space-x-1.5 px-2 pt-2.5 pb-2 lg:pt-3 lg:pb-1.5 text-xs sm:text-sm font-bold transition-colors duration-200 cursor-pointer whitespace-nowrap order-1 lg:order-1 border-r-2 ${activeIndex === 0 ? dividerColor : "border-r-transparent"} lg:border-r-0 ${
                        activeIndex === 0
                    ...
                    <button
                      ...
                      className={`relative flex-1 flex items-center justify-center space-x-1.5 px-2 pt-2.5 pb-2 lg:pt-3 lg:pb-1.5 text-xs sm:text-sm font-bold transition-colors duration-200 cursor-pointer whitespace-nowrap order-2 lg:order-3 border-l-2 ${activeIndex === 2 ? "border-l-blue-400/80 dark:border-l-blue-600/60" : "border-l-transparent"} lg:border-l-0 ${
                        activeIndex === 2
                          ? "text-blue-600 dark:text-blue-400 bg-gradient-to-t from-blue-50/30 to-transparent dark:from-blue-950/5"
                          : "text-slate-400 hover:text-slate-600 dark:text-slate-500 dark:hover:text-slate-300"
                      }`}
